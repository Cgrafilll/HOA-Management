                        ...
                        <div class="ms-3">
                            ...
                            <div class="ms-3">
                                <ul class="list-unstyled">
                                    ...
                                    <li><i class="bi bi-check-circle-fill me-2"></i>First-come, first-served basis no
                                        longer applies</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="ms-3">
                            ...
                            <div class="ms-3">
                                <ul class="list-unstyled">
                                    ...
                                    <li><i class="bi bi-check-circle-fill me-2"></i>Subject to approval and availability
                                    </li>
