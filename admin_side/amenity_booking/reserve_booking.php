                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="calendar-view">
                                        ...
                                        <div class="d-flex gap-3 mt-2 justify-content-center flex-wrap legend">
                                            <small class="d-flex align-items-center">
                                                <span class="badge bg-success me-1 legend-item">●</span> Available
                                            </small>
                                            <small class="d-flex align-items-center">
                                                <span class="badge bg-warning me-1 legend-item">●</span> Partial
                                            </small>
                                            <small class="d-flex align-items-center">
                                                <span class="badge bg-danger me-1 legend-item">●</span> Fully Booked
                                            </small>
                                            <small class="d-flex align-items-center">
                                                <span class="badge bg-secondary me-1 legend-item">●</span> Past
                                            </small>
                                        </div>
