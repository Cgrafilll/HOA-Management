...
try {
    $stmt = $conn->prepare("SELECT * FROM events WHERE status = 'archived' ORDER BY created_at DESC");
    $stmt->execute();
        ...
        <main class="flex-fill p-4">
            <div class="bg-white shadow rounded p-3">
                <div class="bg-success text-white rounded-top p-3">
                    <h5 class="mb-0 fw-bold">Events</h5>
                </div>
                <div class="p-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody class="small align-middle">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">No archived events found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        <?php $total = $eventsResult->num_rows;
