...
<body class="bg-light">
                    ...
                    <form id="rescheduleForm" method="POST" action="amenity_booking/reschedule_booking.php">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="calendar-view-reschedule">
                                    <div class="calendar-header-reschedule">
                                        <button type="button" class="calendar-nav-btn" id="prevMonthReschedule">
                                            <i class="bi bi-chevron-left"></i>
                                        </button>
                                        <div class="fw-bold" id="currentMonthReschedule">Loading...</div>
                                        <button type="button" class="calendar-nav-btn" id="nextMonthReschedule">
                                            <i class="bi bi-chevron-right"></i>
                                        </button>
                                    </div>
                                    <div class="calendar-grid-reschedule" id="calendarGridReschedule">
                            ...
                            <!-- New Time Slot -->
                            <div class="mb-3">
                                <label for="new_rate" class="form-label fw-bold">Select New Time Slot<span
                                        class="text-danger">*</span></label>
                                <div class="rate-options" id="rateOptionsReschedule">
                                    <div class="rate-option" data-value="day"
                                        onclick="selectRescheduleRate(this, 'day')">
                                        <i class="bi bi-sun"></i>
                                        <div>
                                    ...
                                    <div class="rate-option" data-value="night"
                                        onclick="selectRescheduleRate(this, 'night')">
    ...
    `;
        ...
        function updateRescheduleRateOptions(booking) {
            ...
            // Reset
            dayOption.classList.remove('disabled', 'selected');
            nightOption.classList.remove('disabled', 'selected');
            ...
            if (booking) {
                ...
                if (booking.night) {
                    nightOption.classList.add('disabled');
                }
            }
