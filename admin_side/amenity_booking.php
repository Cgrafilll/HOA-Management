                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label for="selected_date_display">Selected Date <span
                                            class="text-danger">*</span></label>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="border rounded p-3 h-100 rate-option" data-value="day"
                                            onclick="selectRescheduleRate(this, 'day')"
                                            style="cursor: pointer; transition: all 0.3s;">
                                            <div class="d-flex align-items-center gap-2">
                                                <i class="bi bi-sun fs-3 text-primary"></i>
                                                <div>
                                                    <strong class="d-block">Day Rate</strong>
                                    ...
                                    <div class="col-6">
                                        <div class="border rounded p-3 h-100 rate-option" data-value="night"
                                            onclick="selectRescheduleRate(this, 'night')"
                                            style="cursor: pointer; transition: all 0.3s;">
                                            <div class="d-flex align-items-center gap-2">
                                                <i class="bi bi-moon-stars fs-3 text-primary"></i>
                                                <div>
                                                    <strong class="d-block">Night Rate</strong>
