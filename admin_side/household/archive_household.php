...
$countSql = "SELECT COUNT(*) as total FROM household_accounts WHERE status = 'Inactive'";
$countResult = $conn->query($countSql);
$totalEntries = $countResult->fetch_assoc()['total'];
$totalPages = ceil($totalEntries / $entriesPerPage);

// Get data for current page (archived accounts only)
$sql = "SELECT household_id, first_name, middle_name, last_name, status, created_at 
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody class="small align-middle" style="min-height: 520px; display: table-row-group;">
                                                ...
                                                <td>
                                                    <div class="dropdown text-center">
                                                        <button class="btn btn-sm btn-success activate-btn"
                                                            data-id="' . htmlspecialchars($household_id) . '" data-bs-toggle="modal" 
                                ...
                                if ($rowCount === 0) {
                                    echo '<tr><td colspan="5" class="text-center text-muted">No inactive household accounts found.</td></tr>';
