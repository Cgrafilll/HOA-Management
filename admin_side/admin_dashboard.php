        ...
        <main class="flex-grow-1 p-4">
            <div class="row g-3 mb-4">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body d-flex align-items-center gap-3">
                            <div class="bg-primary bg-opacity-10 rounded-5 p-3">
                                <span class="text-primary fs-4"><i class="bi bi-hourglass"></i></span>
                            </div>
                            <div>
                                <h5 class="mb-0">12</h5>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        <div class="card-body d-flex align-items-center gap-3">
                            <div class="bg-success bg-opacity-10 rounded-5">
                                <span class="text-success fs-4"><i class="bi bi-house-check"></i></span>
                            </div>
                            <div>
