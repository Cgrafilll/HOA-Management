...
$phpmailer_path = __DIR__ . '/../../admin_side/amenity_booking/PHPMailer/src/PHPMailer.php';
   error_log("PHPMailer path: " . $phpmailer_path);
   error_log("PHPMailer exists: " . (file_exists($phpmailer_path) ? 'YES' : 'NO'));
...
error_log("========== USER DETAILS DEBUG ==========");
error_log("User Type: " . $db_user_type);
error_log("User ID: " . $user_id);
error_log("User Details Retrieved: " . print_r($userDetails, true));
error_log("Email Address from DB: " . ($userDetails['email_address'] ?? 'NOT FOUND'));
error_log("=========================================");
